...
.. list-table:: Dynamic CNN BiGRU Datasets
   ...
   * - barazily (Excluded)
     - N/A
     - N/A
     - `The Need for Speed: An Analysis of Brazilian Malware Classifiers <https://doi.org/10.1109/MSEC.2018.2875369>`_
     - https://github.com/fabriciojoc/brazilian-malware-dataset
     - `zenodo_formatted_dataset.ipynb <https://github.com/scorpionantimalware/sam-cnn-bigru-dynamic-pe-classifier/blob/master/data/zenodo_formatted_dataset.ipynb>`_

   * - apimds-dataset (Excluded)
     - N/A
     - N/A
     - `A Novel Approach to Detect Malware Based on API Call Sequence Analysis <https://doi.org/10.1155/2015/659101>`_
     - https://ocslab.hksecurity.net/apimds-dataset and https://github.com/leocsato/detector_mw
     - `zenodo_formatted_dataset.ipynb <https://github.com/scorpionantimalware/sam-cnn-bigru-dynamic-pe-classifier/blob/master/data/zenodo_formatted_dataset.ipynb>`_
